    ...
    return (
        <section className="weare">
            <div className="weare-container">
                ...
                {/* 3단 그리드 (카드가 아닌 미니멀 리스트 형태로 배치) */}
                <div className="weare-grid">
                    <div className="weare-item">
                        <span className="weare-num">01</span>
                        <h3>🪸 산호초 보호</h3>
                        <p>
                            지구온난화로 인해 발생하는 산호초
                    ...
                    <div className="weare-item">
                        <span className="weare-num">02</span>
                        <h3>♻️ 해양 쓰레기 감소</h3>
                        <p>
                    ...
                    <div className="weare-item">
                        <span className="weare-num">03</span>
                        <h3>📚 환경 교육</h3>
                        <p>
